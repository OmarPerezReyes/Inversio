...
$records = $conexion->prepare('SELECT usuario, nombre, apellido_paterno, apellido_materno, correo, telefono_celular, fecha_nacimiento, curp FROM cliente WHERE id_cliente = :id_cliente');
...
<body>
    ...
    <header class='clearfix'>
        <div id='logo'>
            <img src='assets/img/logoPrincipal.png'>
        </div>
        ...
        <div id='project'>
            ...
            <div><span>DIRECCION</span> Col. Moderna, Cd.Victoria, Tamaulipas, México</div>
